 ...
 * import { startWorkerRpcHost } from "@finapticoos/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@finapticoos/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
