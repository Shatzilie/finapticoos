...
import type { Agent, CompanySecret, EnvBinding, Project, RoutineVariable } from "@finapticoos/shared";
...
const validAdapterValues = {
  ...
  allowedCommands: ["pnpm --filter @finapticoos/ui typecheck", "pnpm build-storybook"],
