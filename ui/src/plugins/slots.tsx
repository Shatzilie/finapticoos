 ...
 *
 * Plugin bundles are built with `external: ["@finapticoos/plugin-sdk/ui", "react", "react-dom"]`,
 * so their ESM output contains bare specifier imports like:
 *
 * ```js
 * import { usePluginData } from "@finapticoos/plugin-sdk/ui";
 ...
 * - `import { ... } from "@finapticoos/plugin-sdk/ui";`
 *
...
function rewriteBareSpecifiers(source: string): string {
  ...
  const rewrites: Record<string, string> = {
    '"@finapticoos/plugin-sdk/ui"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@finapticoos/plugin-sdk/ui'": `'${getShimBlobUrl("sdk-ui")}'`,
    '"@finapticoos/plugin-sdk/ui/hooks"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@finapticoos/plugin-sdk/ui/hooks'": `'${getShimBlobUrl("sdk-ui")}'`,
 ...
 * of `@finapticoos/plugin-sdk/ui`, `react`, and `react-dom` resolve to the
