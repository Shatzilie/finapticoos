...
function registerModuleMocks() {
  vi.doMock("@finapticoos/adapter-opencode-local/server", async () => {
    const actual = await vi.importActual<typeof import("@finapticoos/adapter-opencode-local/server")>("@finapticoos/adapter-opencode-local/server");
    return {
      ...actual,
  ...
  vi.doMock("@finapticoos/shared/telemetry", () => ({
...
describe.sequential("agent permission routes", () => {
  beforeEach(() => {
    vi.resetModules();
    vi.doUnmock("@finapticoos/shared/telemetry");
    ...
    vi.doUnmock("@finapticoos/adapter-opencode-local/server");
    registerModuleMocks();
    vi.resetAllMocks();
