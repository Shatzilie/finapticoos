/**
 * `@finapticoos/plugin-sdk/ui` — Paperclip plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@finapticoos/plugin-sdk` (root).
 *
 ...
 * import { usePluginData, usePluginAction } from "@finapticoos/plugin-sdk/ui";
 * import type { PluginWidgetProps } from "@finapticoos/plugin-sdk/ui";
 *
