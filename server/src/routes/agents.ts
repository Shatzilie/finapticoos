...
import { agents as agentsTable, companies, heartbeatRuns, issues as issuesTable } from "@finapticoos/db";
...
} from "@finapticoos/adapter-utils/server-utils";
import { trackAgentCreated } from "@finapticoos/shared/telemetry";
...
import type { AdapterExecutionTarget } from "@finapticoos/adapter-utils/execution-target";
import type { AdapterEnvironmentCheck } from "@finapticoos/adapter-utils";
...
import { runClaudeLogin } from "@finapticoos/adapter-claude-local/server";
import {
  DEFAULT_ACPX_LOCAL_AGENT,
  DEFAULT_ACPX_LOCAL_MODE,
  DEFAULT_ACPX_LOCAL_NON_INTERACTIVE_PERMISSIONS,
  DEFAULT_ACPX_LOCAL_PERMISSION_MODE,
} from "@finapticoos/adapter-acpx-local";
import {
  DEFAULT_CODEX_LOCAL_BYPASS_APPROVALS_AND_SANDBOX,
  DEFAULT_CODEX_LOCAL_MODEL,
} from "@finapticoos/adapter-codex-local";
import { DEFAULT_CURSOR_LOCAL_MODEL } from "@finapticoos/adapter-cursor-local";
import { DEFAULT_GEMINI_LOCAL_MODEL } from "@finapticoos/adapter-gemini-local";
import { ensureOpenCodeModelConfiguredAndAvailable } from "@finapticoos/adapter-opencode-local/server";
import {
