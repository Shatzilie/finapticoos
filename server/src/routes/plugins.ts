...
import type { ToolRunContext } from "@finapticoos/plugin-sdk";
import { JsonRpcCallError, PLUGIN_RPC_ERROR_CODES } from "@finapticoos/plugin-sdk";
import {
  assertAuthenticated,
  assertBoard,
...
const BUNDLED_PLUGIN_EXAMPLES: AvailablePluginExample[] = [
  {
    packageName: "@finapticoos/plugin-hello-world-example",
  ...
  {
    packageName: "@finapticoos/plugin-file-browser-example",
  ...
  {
    packageName: "@finapticoos/plugin-kitchen-sink-example",
  ...
  {
    packageName: "@finapticoos/plugin-orchestration-smoke-example",
    pluginKey: "finapticoos.plugin-orchestration-smoke-example",
