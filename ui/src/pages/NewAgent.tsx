...
import { AGENT_ROLES, type AdapterEnvironmentTestResult } from "@finapticoos/shared";
...
export function NewAgent() {
  ...
  const availableSkills = (companySkills ?? []).filter((skill) => !skill.key.startsWith("Shatzilie/finapticoos/"));
